  ...
  return (
    <section id="contact" className="section section-alt">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <form name="quote" method="POST" data-netlify="true" className="max-w-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <textarea name="message" placeholder="Tell us about the project" className="p-3 border rounded md:col-span-2"></textarea>
          <button type="submit" className="btn btn-primary md:col-span-2">Request Quote</button>
        </form>
